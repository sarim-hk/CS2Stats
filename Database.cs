...
namespace CS2Stats {
    public partial class Database {
        ...
        public async Task UpdateMatch(int? matchID, string winningTeamID, string losingTeamID, int? winningTeamScore, int? losingTeamScore, int? winningSide, int deltaELO, ILogger Logger) {
            try {
                string query = @"
                UPDATE CS2S_Match
                SET
